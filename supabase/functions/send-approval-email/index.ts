...
const FROM_EMAIL = 'noreply@tongyanginc.co.kr'
const FROM_NAME = '동양 내부회계 LMS'
    ...
    html: `
      <div style="font-family: 'Malgun Gothic', sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background: linear-gradient(135deg, #4f46e5, #7c3aed); padding: 24px; border-radius: 12px 12px 0 0; text-align: center;">
          <h1 style="color: white; margin: 0; font-size: 20px;">(주)동양 내부회계 LMS</h1>
          <p style="color: rgba(255,255,255,0.8); margin: 8px 0 0; font-size: 13px;">TONGYANG ACCOUNTING EDUTECH</p>
        </div>
        <div style="background: #f9fafb; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 12px 12px; padding: 28px;">
          ...
          <div style="text-align: center; margin-top: 24px;">
            <a href="https://tongyang-portal.vercel.app/inbox" 
        ...
        <p style="text-align: center; color: #9ca3af; font-size: 11px; margin-top: 16px;">
          이 메일은 동양 내부회계 LMS에서 자동 발송되었습니다.
        </p>
      </div>
    `,
  }),
  approved: (p: EmailPayload) => ({
    ...
    html: `
      <div style="font-family: 'Malgun Gothic', sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #f9fafb; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 12px 12px; padding: 28px;">
          ...
          <div style="text-align: center; margin-top: 24px;">
            <a href="https://tongyang-portal.vercel.app/evidence" 
